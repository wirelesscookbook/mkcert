#!/bin/bash
#
# SSL certificate installation functions
# Author: @billz <billzimmerman@gmail.com>
# License: https://github.com/wirelesscookbook/captive/blob/master/LICENSE
...
function _install_log() {
    echo -e "${ANSI_GREEN}mkcert${component}: $1${ANSI_RESET}"
}
